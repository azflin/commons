...
import { BootWavePainter } from "./boot-wave-render"
...
class BootWaveRenderable extends FrameBufferRenderable {
  private painter = new BootWavePainter()
...
declare module "@opentui/solid" {
  interface OpenTUIComponents {
    boot_wave: typeof BootWaveRenderable
  }
}

extend({ boot_wave: BootWaveRenderable })

export function BootWave() {
